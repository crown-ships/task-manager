...
export default connect(
  mapStateToProps,
    { getAllInvestments, getFilteredProjects, getAllReturns, deleteReturn, updateReturn, registerReturn, deleteInvestment, updateInvestment, registerInvestment, logoutUser, getAllPayments, deletePayment, updatePayment, registerPayment, getAllInvestors, deleteInvestor, updateInvestor, registerInvestor, getAllProjects, getAllCompanies, deleteProject, updateProject, registerProject, getAllVendors, deleteVendor, updateVendor, registerVendor}
