...
export const updateReturn = (userData, history) => dispatch => {
  axios
    .post("http://localhost:4000/api/updReturn", userData.body, {params:userData.params})
    .then(res => {
      console.log("updated");
    })
    .catch(err =>
...
export const deleteReturn = (userData, history) => dispatch => {
  ...
  axios
    .delete("http://localhost:4000/api/delReturn", {params:userData})
...
export const getAllReturns = (userData, history) => {
  return function (dispatch) {
    return axios
    .get("http://localhost:4000/api/getReturns", {params:userData})
    .then(res => {
      return res.data;
    })
    .catch(err =>
...
export const registerReturn = (userData, history) => dispatch => {
  console.log(userData);
  axios
    .post("http://localhost:4000/api/newReturn", userData.body, {params:userData.params})
    .then(res => {
